...
export class UIManager {
    ...
    private stylesModal: HTMLElement;
    ...
    private currentFontSize: number = 1.333; // Default size in rem

    private savedState: { theme: string; fontIndex: number; fontSize: number } = {
        theme: 'default-dark',
        fontIndex: 0,
        fontSize: 1.333
    };
    ...
    constructor(editorElement: HTMLElement) {
        ...
        this.stylesModal = document.getElementById('styles-modal') as HTMLElement;
    ...
    private setupModalListeners() {
        ...
        this.infoModal.addEventListener('click', (e) => {
            if (e.target === this.infoModal) this.closeModal();
        });
    ...
    private initCustomSelects() {
        ...
        if (themeSelect) {
            ...
            trigger?.addEventListener('click', (e) => {
                ...
                document.querySelectorAll('.custom-select.open').forEach(el => {
                    if (el !== themeSelect) el.classList.remove('open');
                });
        ...
        if (fontSelect) {
            ...
            trigger?.addEventListener('click', (e) => {
                ...
                // Close others
                document.querySelectorAll('.custom-select.open').forEach(el => {
                    if (el !== fontSelect) el.classList.remove('open');
                });
    ...
    private loadAppearance() {
        ...
        if (savedFontIndex !== null) this.savedState.fontIndex = parseInt(savedFontIndex, 10);
        
        const savedFontSize = localStorage.getItem('currentFontSize');
        if (savedFontSize !== null) this.savedState.fontSize = parseFloat(savedFontSize);
    ...
    private updateStyleUI() {
        ...
        if (themeSelect) {
            ...
            if (displayText && foundState) displayText.textContent = foundState.name;
        }
